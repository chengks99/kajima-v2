...
class CameraStream(object):
    ...
    def update(self):
        while self.started:
            ...
            self.frame_saved.append(frame)
            self.grabbed_saved.append(grabbed)
    ...
    def read(self):
        ...
        # print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
        self.read_lock.acquire()
        image = self.frame_saved[0].copy()
        grabbed = self.grabbed_saved[0]
        self.frame_saved.pop(0)
        self.grabbed_saved.pop(0)
        self.read_lock.release()
