...
class Camera(Adaptor):
    def __init__(self, args, **kw):
        ...
        self.run()
        self.df = pd.DataFrame(columns=['frame_num','human_id','X','Y','pmv'])
    ...
    def process_stream (self):
        ...
        # src = glob.glob("./7003_frame/*.png")
        src = glob.glob('/home/jk/Desktop/Accuracy result/Original frame/7003_frame/*.png')
    ...
    def cam_run (self):
        ...
        for image in self.stream :
            ...
            if boxes is not None:
                ...
                # boxes, person_crop, face_labels, tids, lmks, image, pmvs, actions, clothatt  = _output
            ...
            if self.view:
                ...
                cv2.imwrite("/home/jk/Desktop/Accuracy result/PRDCSG_results/New/7003/{}.png".format(str(frame_num_count).zfill(5)),image)
            ...
            ## Check the results will be box after the editing 
                ...
                self.df.to_csv("7003_results.csv",index=False)
